      ...
      <li>
        ...
        <div class="container-fluid">
          <div class="row">
            <div class="col-md-12">
                <div class="jumbotron">
                  <h2>SELAMAT DATANG DI AuRa CAKE & COOKIES</h2>
                  <p>AuRa Cake & Cookies Merupakan Toko Kue yang Saya dirikan pada tahun 2018 </p>
                  <p><a class="btn btn-warning btn-lg"  role="button">Selengkapnya</a></p>
              </div>
            </div>
          </div>
          </div><!-- Akhir Jumbotron -->
          ...
          <div class="col-md-12">
            ...
            <a href="index.php">Home </a> | <a href="Menu Cookies.php">Menu </a> | <a href="About Us.php">About Us </a>| <a href="Data Pelanggan.php">Data Pelanggan </a><br/><br/>
